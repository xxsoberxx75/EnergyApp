...
final Map<String, List<Question>> quizData = {
  'Safety': [
    ...
    Question(
      question:
          'What should you avoid using inside the house during strong winds?',
      options: ['Torches', 'Battery lamps', 'Kerosene lamps', 'Solar lanterns'],
      correctIndex: 2,
      explanation:
    ...
    Question(
      question:
          'When experiencing electrical shocks from appliances, what should you do?',
      options: [
    ...
    Question(
      ...
      correctIndex: 1,
      explanation:
          'Water conducts electricity. Switch off the main breaker immediately.',
    ),
    Question(
    ...
    Question(
      ...
      correctIndex: 1,
      explanation: 'Stay far from overhead lines to prevent electrocution.',
    ),
  ],
  ...
  'Energy': [
    Question(
      question:
          'Which home appliance typically uses the most electricity in Mauritius?',
      options: ['Phone charger', 'LED bulb', 'Air conditioner', 'Laptop'],
      correctIndex: 2,
      explanation:
    ...
    Question(
      ...
      correctIndex: 1,
      explanation:
          'LED bulbs save up to 80% energy compared to CFL or incandescent bulbs.',
    ),
    Question(
      ...
      correctIndex: 1,
      explanation: 'Switching off unused lights reduces wasted electricity.',
    ),
    Question(
    ...
    Question(
      ...
      correctIndex: 1,
      explanation: 'Fans consume about 20x less energy than air conditioners.',
    ),
    Question(
    ...
    Question(
      ...
      correctIndex: 1,
      explanation:
          'Switching off appliances prevents energy waste and hazards.',
    ),
  ],
  ...
  'Cyclone Tips': [
    ...
    Question(
      question:
          'In Mauritius, which organisation issues official cyclone bulletins?',
      options: [
        'CEB',
        'MBC',
    ...
    Question(
      ...
      correctIndex: 1,
      explanation:
          'Class IV means cyclone conditions are present — stay inside.',
    ),
    Question(
      ...
      correctIndex: 2,
      explanation: 'Battery-powered lights reduce fire hazards indoors.',
    ),
    Question(
      ...
      correctIndex: 0,
      explanation: 'Tape helps prevent collapse and reduces glass shattering.',
    ),
    Question(
      question:
          'What should you avoid doing outside immediately after a cyclone?',
      options: [
      ...
      correctIndex: 1,
      explanation: 'Fallen lines may still be live and extremely dangerous.',
    ),
    Question(
